...
public class RpcClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private ExecutorService exceptionThreadPool;

    public RpcClientHandler(ThreadPool workThreadPool, ExecutorService exceptionThreadPool) {
        super();
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        log.debug(errMsg);
        exceptionThreadPool.submit(new Runnable() {
            @Override
            public void run() {
